...
public class Animator : GLib.Object {
    ...
    public bool is_active { get {return this.state != 1.0;} } 
    ...
    public Animator.linear(double start, double end, double duration) {
        this.val = start;
        this.start = start;
        this.end = end;
    ...
    public Animator.cubic(Direction direction, double start, double end, double duration, double multiplier = 0) {
        this.val = start;
        this.start = start;
        this.end = end;
        this.duration = duration;
    ...
    public void update(double time) {
        ...
        } else if (this.val != this.end || this.state != 1.0) {
             this.val = this.end;
             this.state = 1.0;
        }  
    }
